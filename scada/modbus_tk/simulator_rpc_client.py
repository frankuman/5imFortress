...
import socket
import scada.modbus_tk.defines
...
if __name__ == "__main__":
    ...
    print(modbus_simu.add_block(12, "toto", scada.modbus_tk.defines.COILS, 0, 100))
    ...
    print(modbus_simu.add_block(12, "titi", scada.modbus_tk.defines.COILS, 100, 100))
