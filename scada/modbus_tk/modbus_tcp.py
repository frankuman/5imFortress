...
from scada.modbus_tk import LOGGER
...
class TcpServer(Server):
    ...
    for example: You must set address to 'localhost', if youjust want to accept local connections
    """

    def __init__(self, port=502, address='127.0.0.1', timeout_in_sec=1, databank=None, error_on_missing_slave=True):
