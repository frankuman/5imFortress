...
import scada.modbus_tk
from scada.modbus_tk import hooks
from scada.modbus_tk import modbus
from scada.modbus_tk import modbus_tcp
from scada.modbus_tk import modbus_rtu

if scada.modbus_tk.utils.PY2:
...
LOGGER = scada.modbus_tk.utils.create_logger(name="console", record_format="%(message)s")
